...
export default function ProfileReceived(props) {
  ...
  {
    id: 'Self Evalution	',
    label: 'Self Evalution	',
    minWidth: 50,
   }  
   ,
   {
     id: 'Send for Evalution',
     label: 'Send for Evalution	',
     minWidth: 50,
    }
    ,
    {
  ...
  return (
    ...
    <Dialog
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">Profile Received</DialogTitle>
        <DialogContent>
